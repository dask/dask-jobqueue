...
function jobqueue_install {
    docker exec sge_master /bin/bash -c "conda activate dask-jobqueue; cd /dask-jobqueue; pip install -e ."
}

function jobqueue_script {
    docker exec sge_master /bin/bash -c "cd; conda activate dask-jobqueue; pytest /dask-jobqueue/dask_jobqueue --verbose -s -E sge"
}
